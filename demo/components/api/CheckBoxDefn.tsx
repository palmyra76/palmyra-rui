...
const CheckBoxDefn = () => {
    ...
    const CheckBoxImport = `import { MuiCheckBox } from "palmyra/MuiCheckBox"`
    ...
    const data: GridProperties = [
        ...
        { property: 'icon', type: `any`, description: `The icon to display when the component is unchecked.` },
        { property: 'checkedIcon', type: `any`, description: `The icon to display when the component is checked.` }
    ]
