...
const IntegerFieldDefn = () => {
    ...
    const IntegerFieldImport = `import { MuiIntegerField } from "palmyra/MuiIntegerField"`
    ...
    const data: GridProperties = [
        ...
        { property: 'title', type: 'string', description: `The title of the Integer field.` },
        { property: 'label', type: 'string', description: `The label of the Integer field.` },
        ...
        { property: 'className', type: 'string', description: `Customize the Integer field style.` },
...
export default IntegerFieldDefn;