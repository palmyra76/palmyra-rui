...
const ea = le(function(t, r) {
  ...
  const n = e.store || r.store, a = e.lookupOptions || {}, o = a.idAttribute || "id", c = a.titleAttribute || "name", l = a.searchAttribute || c, d = r.data, p = ie(0), [f, h] = ee(null), [g, L] = ee([]), [E, x] = ee(""), [$, W] = ee(!1), S = $ && g.length < (f ? 2 : 1), m = {
    store: n,
    ...
    quickSearch: l,
    initialFetch: !1
  }, b = Me(m), { setQueryFilter: s, setQuickSearch: k, filter: w, totalRecords: Y, refreshData: z } = b, G = b.data, X = Re(o) ? (O) => _e(o, O) : (O) => O == null ? void 0 : O[o], D = Re(c) ? (O) => _e(c, O) : (O) => O == null ? void 0 : O[c];
  function Q() {
    if (d) {
      var O = {};
      rt(o, O, d);
  ...
  ye(() => {
    ...
    const O = G ? [...G] : [], H = f;
    O && H && !F(O, X(H)) && O.unshift(H), L(O), p.current < Y && (p.current = Y);
  }, [G, Y]);
  function F(O, H) {
    return O.find((J) => {
      if (X(J) == H)
  ...
  function j() {
    $ && (E.length > 0 && E != D(f) ? k("*" + E + "*") : G ? k(null) : z());
  }
  return {
    getSelectedOption: Q,
    filter: w,
...
function Br() {
  return ut || (ut = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var s = d, k = p, w = l, Y = c, z = t, G = f, X = n, D = E, Q = L, F = r, j = o, B = a, O = h, H = !1;
    function J(y) {
...
(function(e) {
  ...
  var t = g(pe), r = f(zt), n = f(At), a = f(en), o = U, c = fe, l = de, d = f(Ae), p = f(ke);
  function f(S) {
  ...
  class W extends t.Component {
    ...
    constructor(m) {
      super(m), E(this, "onDragStart", (b, s) => {
        ...
        if (this.props.bounds) {
          ...
          w.x = X, w.y = D, w.slackX = this.state.slackX + (z - w.x), w.slackY = this.state.slackY + (G - w.y), k.x = w.x, k.y = w.y, k.deltaX = w.x - this.state.x, k.deltaY = w.y - this.state.y;
        }
    ...
    render() {
      ...
      let F = {}, j = null;
      const O = !!!G || this.state.dragging, H = G || k, J = {
