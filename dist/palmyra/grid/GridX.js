  ...
  return /* @__PURE__ */ e("div", { children: /* @__PURE__ */ i("div", { children: [
    ...
    /* @__PURE__ */ i("div", { className: "grid-header", children: [
      ...
      /* @__PURE__ */ i("div", { className: "grid-header-button", children: [
        /* @__PURE__ */ e(h, { title: "Filter", placement: "top", children: /* @__PURE__ */ e(u, { className: "grid-btn", disableRipple: !0, onClick: () => x(!0), children: /* @__PURE__ */ e(pe, { className: "grid-button-icon" }) }) }),
        /* @__PURE__ */ e(
          ge,
          {
            columns: f,
