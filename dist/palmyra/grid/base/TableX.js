...
import { Box as P, TableContainer as y, Paper as F, Table as H, TableHead as M, TableRow as u, TableBody as N, TableCell as j } from "@mui/material";
...
function K({ columnDefs: g, rowData: t, onRowClick: h, onRowStyle: p, onHeaderStyle: b, onSortColumn: m, EmptyChild: f, customizer: i }) {
  ...
  return /* @__PURE__ */ e(P, { sx: { width: "100%" }, children: /* @__PURE__ */ c(y, { component: F, sx: { border: "1px solid var(--border-color)", borderRadius: "5px" }, children: [
    /* @__PURE__ */ c(H, { sx: { minWidth: 650 }, "aria-label": "simple table", className: "table", children: [
      ...
      t == null || t == null || t.length == 0 ? /* @__PURE__ */ e(a, {}) : /* @__PURE__ */ e(N, { children: r.getRowModel().rows.map((l) => {
      ...
      t == null || t == null || t.length == 0 ? /* @__PURE__ */ e(a, {}) : /* @__PURE__ */ e("tfoot", { children: r.getFooterGroups().map((l) => /* @__PURE__ */ e("tr", { style: { textAlign: "end" }, children: l.headers.map((n) => /* @__PURE__ */ e("th", { children: n.isPlaceholder ? null : s(
        n.column.columnDef.footer,
        n.getContext()
      ) }, n.id)) }, l.id)) })
    ] }),
    t == null ? /* @__PURE__ */ e("div", { children: /* @__PURE__ */ e(k, {}) }) : t == null ? /* @__PURE__ */ e("div", { children: "Error while loading data" }) : t.length == 0 ? /* @__PURE__ */ e(f, {}) : /* @__PURE__ */ e(a, {})
  ] }) });
}
export {
  K as default
