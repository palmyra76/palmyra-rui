...
const B = C(function(t, i) {
  const l = g(h), u = t.displayPattern || t.serverPattern || "YYYY-MM-DD HH:mm:ss", r = l(t, "datetime"), o = r.error, c = r.data, a = r.eventListeners, s = v(null), m = () => P(c);
  D(i, () => ({
    focus() {
      s.current.focus();
    },
