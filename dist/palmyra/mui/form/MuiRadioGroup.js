...
import { FormControl as z, RadioGroup as k, FormHelperText as w, FormControlLabel as h, Radio as F } from "@mui/material";
...
const X = V(function(t, f) {
  const O = j(N), m = f || b(null), { options: x } = t, n = O(t, "radio", m), { mutateOptions: M, setMutateOptions: a } = n, y = t.flexDirection != "column", i = n.error, s = n.eventListeners, C = t.autoFocus || !1, u = b(null);
  p(m, () => ({
    focus() {
      u.current.focus();
    },
  ...
  var B = {
    ...
    onFocus: s.onFocus,
    onChange: (e) => {
      L || s.onValueChange(e.target.value);
    }
  };
  const D = (e) => {
    if (e) {
  ...
  return /* @__PURE__ */ o(G, { children: M.visible && /* @__PURE__ */ o(
    P,
    {
      ...
      children: /* @__PURE__ */ I(z, { fullWidth: !0, error: i.status, children: [
        /* @__PURE__ */ o("div", { children: t.label }),
        /* @__PURE__ */ o(k, { icon: !0, row: y, ...B, ...g, children: D(x) }),
        /* @__PURE__ */ o(w, { className: "form-error-text", children: i.message })
      ] })
    }
  ) });
});
