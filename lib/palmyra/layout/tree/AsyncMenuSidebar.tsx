...
const AsyncMenuSidebar = (props: SidebarInput) => {
  ...
  const factory: PalmyraStoreFactory = new PalmyraStoreFactory({ baseUrl: "/api" });
  const treeStore: any = factory.getTreeStore({}, endPoint);
